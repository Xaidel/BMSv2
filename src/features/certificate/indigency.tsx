        ...
        <Card className="flex-2 flex flex-col justify-between">
          <CardHeader>
            ...
            <CardDescription className="text-start">
              Please fill out the necessary information needed for Indigency Certification
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div>
                  ...
                  <View style={styles.section}>
                    ...
                    {selectedResident ? (
                      <>
                        ...
                        <Text style={[styles.bodyText, { textAlign: "justify", marginBottom: 8 }]}>
                          This certifies further that the above-named person belongs to the <Text style={{ fontWeight: "bold" }}>Indigency</Text> sector in this Barangay and is duly recognized as such by the local government unit.
                        </Text>
                        <Text style={[styles.bodyText, { textAlign: "justify", marginBottom: 8 }]}>
