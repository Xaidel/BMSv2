      ...
      <div className="flex gap-1 ">
        <Card className="flex-2 flex flex-col justify-between">
          ...
          <CardContent>
            ...
            <div className="mt-4">
              <label htmlFor="amount" className="block text-sm font-medium text-gray-700 mb-1">Enter Amount (PHP)</label>
              <input
                id="amount"
                type="text"
                  ...
                  <View style={styles.section}>
                    ...
                    {selectedResident ? (
                      <>
                        ...
                        <Text style={[styles.bodyText, { textAlign: "justify", marginBottom: 8 }]}>
                          This is to certify that <Text style={{ fontWeight: "bold" }}>{`${selectedResident.first_name} ${selectedResident.last_name}`.toUpperCase()}</Text>
                          {`, ${age || "___"} years old, ${civilStatus || "___"}, a resident of Zone 1, Tambo Pamplona Camarines Sur since 1997.`} He is known to me of good moral character and at present has no any criminal records and/or any case in this Barangay.
                        </Text>
                        <Text style={[styles.bodyText, { textAlign: "justify", marginBottom: 8 }]}>
                          This certification is being issued upon request of the above named-person for record, reference and other legal matters this may serve.
                        </Text>
